...
extension UIColor {
     ...
     */
    struct Colors {
        static let appDarkText      = "#231F20"
        static let appLightText     = "#FFFFFF"
        static let appScreenBG      = "#E8E3D9"
        static let appHeaderBG      = "#C2BFB8"
        static let appTabBarBG      = "#231F20"
        static let appSeparatorLine = "#231F20"
        static let appButtonBorder  = "#231F20"
        static let appButtonBG      = "#231F20"
        static let appButtonText    = "#FFFFFF"
        static let appTextFieldBG   = "#FFFFFF"
        static let appTextFieldText = "#231F20"
        static let appThemeBlue     = "#008CCC"
        static let appThemeGray     = "#878785"
    }
